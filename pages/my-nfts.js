  ...
  return (
    <div className="w-full flex justify-start items-center flex-col min-h-screen">
      <div className="w-full flexCenter flex-col">
        <Banner bannerText="Your NFTs" childStyles="text-center mb-4" parentStyles="h-80 justify-center" />
      ...
      {!isLoading && nfts.length === 0 ? (
        <div className="flexCenter sm:-4 p-16">
          <h1 className="font-poppins dark:text-white text-nft-black-1 font-extrabold text-3xl">No Products Owned</h1>
        </div>
      ) : (
